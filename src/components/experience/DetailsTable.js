					...
					<div className='col-lg-8 col-sm-12'>
						...
						>
							<tbody>
								...
								<tr>
									<td style={{ width: '60px' }}>Co-Founder/Workers</td>
								...
								<tr>
									...
									<td style={{ opacity: '0.4' }}><a href={`${details.achievements}`} className='link' target='_blank' rel='noopener noreferrer'>{details.achievements}</a></td>
								</tr>
							</tbody>
						</Table>
					</div>
