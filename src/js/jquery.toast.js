		...
		animate: function () {
			...
			if (this.canAutoHide()) {
				...
				window.setTimeout(function () {
					if (_that.options.showHideTransition.toLowerCase() === 'fade') {
						_that._toastEl.trigger('beforeHide');
						_that._toastEl.fadeOut(function () {
							_that._toastEl.trigger('afterHidden');
						});
					} else if (
						_that.options.showHideTransition.toLowerCase() === 'slide'
					) {
						_that._toastEl.trigger('beforeHide');
						_that._toastEl.slideUp(function () {
							_that._toastEl.trigger('afterHidden');
						});
					} else {
						_that._toastEl.trigger('beforeHide');
						_that._toastEl.hide(function () {
							_that._toastEl.trigger('afterHidden');
						});
					}
				}, _that.options.hideAfter);
			}
		},
